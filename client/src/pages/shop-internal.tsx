...
import { InternalWithShop } from "./internal";

export default function ShopInternal() {
  ...
  return <InternalWithShop shop={shop ? { name: shop.name, logoUrl: shop.logoUrl, brandColor: shop.brandColor } : null} />;
}
